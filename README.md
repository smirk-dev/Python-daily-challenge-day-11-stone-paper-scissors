...
# ✊📄✂️ Rock, Paper, Scissors (Pygame) - Day 11

## 📝 Description
This is a **classic Rock, Paper, Scissors game** built with **Python and Pygame**.  
The game features **hover effects**, **sound effects**, and **real-time results**  
where the user competes against the computer.

## 🎯 Features
✔️ **Interactive UI** with hover effects on buttons.  
✔️ **Sound effects** for clicks, wins, losses, and draws.  
✔️ **Randomized computer moves** for fair gameplay.  
✔️ **Instant feedback** with result display.  

## 🛠️ Requirements
- Python  
- Pygame  
- Image assets: `rock.png`, `paper.png`, `scissors.png`  
- Sound assets: `click.wav`, `win.wav`, `lose.wav`, `draw.wav`  
